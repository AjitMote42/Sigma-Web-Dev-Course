...
async function getSongs(folder) {
    ...
    for (const song of songs) {
        songUL.innerHTML = songUL.innerHTML + `<li><img class="items-invert" width="34" src="img/music.svg" alt="">
                            <div class="info">
...
async function displayAlbums() {
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        if (e.href.includes("/songs") && !e.href.includes(".htaccess")) {
            ...
            fill="#000"
            style="width: 100%; height: 100%; stroke: #000; stroke-width: 1.5; stroke-linejoin: round; fill: none;">
            <path
